...
def define_aliases(alias_d, cls=...):  # -> partial[Unknown]:
    """
...
def nargs_error(name, takes, given):  # -> TypeError:
    """Generate a TypeError to be raised by function calls with wrong arity."""
    ...

def kwarg_error(name, kw):  # -> TypeError:
    """
...
def recursive_subclasses(cls):  # -> Generator[Unknown, Unknown, None]:
